...
   		,SUM(Realizado_Real) as Realizado_Real  
	FROM (
		--DECLARE @cod_Origem INT = 1, @dat_Referencia DATE = '2023-04-12', @cod_Regional INT = 1, @cod_Status INT = 4,@dat_Encerramento DATETIME = '2023-04-12 23:59:59.999' -- alterar
...
   		UNION all
		...
		UNION all
		--DECLARE @cod_Origem INT = 1, @dat_Referencia DATE = '2023-04-12', @cod_Regional INT = 1, @cod_Status INT = 4,@dat_Encerramento DATETIME = '2023-04-12 23:59:59.999' 
